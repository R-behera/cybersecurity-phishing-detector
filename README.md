...
# Cybersecurity Phishing Detector

![Demo Screenshot](demo/screenshot.png)

## Overview
Score phishing risk from message content and metadata and surface suspicious indicators to analysts.
